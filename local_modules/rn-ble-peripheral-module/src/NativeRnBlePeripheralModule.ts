 ...
 */
export enum ManagerAuthorization {
  NotDetermined = 0,
  Restricted = 1,
  Denied = 2,
  AllowedAlways = 3,
...
export type EventDidUpdateState = {
  state: number; // ManagerState value
...
export type EventDidReceiveReadRequest = {
  requestId: number; // Used to respond to this request
  centralUUID: string;
  characteristicUUID: string;
  serviceUUID: string;
  offset: number;
...
export type EventDidReceiveWriteRequests = {
  requestId: number; // Used to respond to these requests
  requests: Array<{
    centralUUID: string;
    characteristicUUID: string;
    serviceUUID: string;
...
export interface Spec extends TurboModule {
  ...
  // ==========================================================================
  // EVENT EMITTERS - All CBPeripheralManagerDelegate callbacks
  // ==========================================================================
...
export default TurboModuleRegistry.getEnforcing<Spec>('RnBlePeripheralModule');
